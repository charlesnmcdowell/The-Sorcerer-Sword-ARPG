...
BRIEFS = {
  ...
  "Proctor":     "Ashenveil academy enforcer, male, precise glacial tenor, faculty condescension worn like a robe, grades his victims while he kills them, never hurried, never warm.",
  "BrassHost":   "Cheery magitech-city innkeeper, androgynous bright mid-range, quick sing-song hospitality patter, always gently upselling, sunny as a rune-lamp.",
  "PitBones":    "A dead pit-fighter's skeleton, hollow rattling whisper like wind through a ribcage, dry bone-clatter cadence, slow and mournful, still half-dreaming of the crowd.",
  "PitBrute":    "An enormous slow-witted pit ogre, male, deep dull boulder of a voice, very few words, long pauses, each sentence dropped like a stone.",
  "FrostWight":  "A frozen undead spirit, androgynous breathy hiss like wind over ice, freezing and intimate, words crystallizing one at a time, hunger wrapped in lullaby calm.",
  "Kagehime":    "Female samurai duelist, late twenties, cool glassy alto with refined Japanese-accented English like her senior schoolmate but quicker and hungrier, ambition sharpened to a point, politeness worn like a blade guard.",
...
LINES = [
  ...
  { "id": "m_backroom", "slot": "Marlow", "who": "MARLOW",
    ...
    "vtext": "[dry, friendly] Rumor is my trade, not my charity. Five silver opens the back room. [short pause] [counting quietly] Three roads. Three vanishings this season. A lifter. A firecaller. A girl who sang birds down out of the trees. [pause] All gifted. All gone at the new moon. [low] And the wagons... always roll WEST." },
  ...
  { "id": "e_nc_death", "slot": "Necromancer", "who": "THE COURT NECROMANCER",
    "text": "The ledger... does not close... someone else... already holds... the pen...",
    "vtext": "[failing, papery] The ledger... does not close... [rattling breath] someone else... already holds... the pen..." },
  ...
  { "id": "w_fold", "slot": "Vessia", "who": "VESSIA",
    "text": "There's the waystation. They pack people like freight. Tonight we tear it open.",
    "vtext": "[cold, quiet] There's the waystation. [short pause] They pack people... like FREIGHT. [steel] Tonight, we tear it open." },
  ...
  { "id": "w_run", "slot": "Vessia", "who": "VESSIA",
    "text": "Run home, stone-boy. And tell everyone what nearly happened to you - a story travels faster than any wagon.",
    "vtext": "[gentle, then iron] Run home, stone-boy. [short pause] And tell EVERYONE what nearly happened to you. [dry] A story travels faster than any wagon." },
  ...
  { "id": "w_price", "slot": "Vessia", "who": "VESSIA",
    "text": "Mm. Now that is worth knowing.",
    "vtext": "[pleased, silken] Mm. [short pause] Now THAT... is worth knowing." },
  ...
  { "id": "k_orders", "slot": "Tsubaki", "who": "TSUBAKI",
    "text": "Three tasks, then. Rebuild the route. Find the arsonist's trail. And mark every gift between here and Karridge worth a page. Consider it written, my Lady.",
    "vtext": "[calm, reading] Three tasks, then. [short pause] Rebuild the route. Find the arsonist's trail. And mark every gift between here and Karridge... worth a page. [soft] Consider it written, my Lady." },
  ...
  { "id": "k_price", "slot": "Tsubaki", "who": "TSUBAKI",
    "text": "A fine technique. It joins my collection.",
    "vtext": "[pleased, serene] A fine technique. [soft] It joins my collection." },
  ...
  { "id": "k_patience", "slot": "Tsubaki", "who": "TSUBAKI",
    "text": "There he is. The assignment beneath all my assignments. Not here - not with witnesses. The Lady needs him charmed, not warned. So I wait.",
    "vtext": "[breath catching, hushed] There he is. The assignment beneath ALL my assignments. [short pause] Not here. Not with witnesses. [composed again] The Lady needs him charmed... not warned. [soft] So I wait." },
  ...
  { "id": "k_go", "slot": "Tsubaki", "who": "TSUBAKI",
    "text": "Run to the Ashenveil, little moth. Tell the Lady her road is open again - and that I will find whoever sold us to the school.",
    "vtext": "[quiet command] Run to the Ashenveil, little moth. Tell the Lady her road is open again... [cold] and that I will find whoever SOLD us to the school." },
  ...
  { "id": "k_deliver", "slot": "Tsubaki", "who": "TSUBAKI",
    "text": "The route is running again. The school is broken. Eleven new names for the ledger - marked, priced, and waiting. And one small vial... from an errand the Lady set me, long ago.",
    "vtext": "[formal report] The route is running again. The school is broken. Eleven new names for the ledger - marked, priced, and waiting. [long pause] [softer] And one small vial... from an errand the Lady set me... long ago." },
  ...
  { "id": "n_kclose", "slot": NARR, "who": "NARRATOR",
    ...
    "vtext": "[quiet, ominous] She sharpens the katana twice that night... though it does not need it. [pause] Somewhere west, an emperor travels alone... the way weather travels. [long pause] [low] The web has a new spider. [quieter] And the spider... is smiling." },
  ...
  # ---- 2026-08-11 unused-art pass: THE SECOND BLADE (rival samurai, both roads) ----
  { "id": "k_duel", "slot": "Tsubaki", "who": "TSUBAKI",
    "text": "The Keep is emptied - and my Lady's answer already stands at the broken gates, wearing my own school's colors. Kagehime. The Second Blade. So. I am to be tested twice tonight.",
    "vtext": "[quiet, reading the situation] The Keep is emptied... and my Lady's answer already stands at the broken gates. [pause] Wearing my OWN school's colors. [cool recognition] Kagehime. The Second Blade. [faint dry amusement] So. I am to be tested... twice tonight." },
  { "id": "e_k2_meet", "slot": "Kagehime", "who": "KAGEHIME",
    "text": "The Matron sends her regards, senior sister. Sera of Duskfen left so much of you standing - my Lady wonders whether what remains is still worth keeping. Draw.",
    "vtext": "[courteous, hungry underneath] The Matron sends her regards... senior sister. [short pause] Sera of Duskfen left SO much of you standing. My Lady wonders whether what remains... is still worth KEEPING. [flat] Draw." },
  { "id": "e_k2_intro", "slot": "Kagehime", "who": "KAGEHIME",
    "text": "No orders bind me tonight, Tsubaki. Only curiosity. You always said victory was your nature - show me its face.",
    "vtext": "[bright, dangerous] No orders bind me tonight, Tsubaki. Only curiosity. [pause] You always said victory was your NATURE. [drawing steel] Show me its face." },
  { "id": "e_k2_death", "slot": "Kagehime", "who": "KAGEHIME",
    "text": "Enough. I will tell her the Blade is still the Blade. Finish the errand, sister... and watch your back. I was only the second they sent.",
    "vtext": "[winded, yielding with grace] Enough. [breath] I will tell her... the Blade is still the Blade. [quieter] Finish the errand, sister. And watch your back. [almost a warning smile] I was only the SECOND they sent." },
  { "id": "e_mb_intro", "slot": "Kagehime", "who": "THE MATRON'S BLADE",
    "text": "You burned a pipeline, arsonist, and pipelines have owners. My Lady would like her ledger balanced - your name, your gift, and your ashes will settle the page. Sing for me.",
    "vtext": "[courteous menace] You burned a pipeline, arsonist. And pipelines... have owners. [short pause] My Lady would like her ledger balanced. Your name. Your gift. [soft] And your ashes will settle the page. [drawing steel] Sing for me." },
  ...
  { "id": "e_pr_intro", "slot": "Proctor", "who": "THE ASHENVEIL PROCTOR",
    "text": "Vessia of the lower halls. You left the academy with a question - the faculty has sent me with the answer. Hold still for your assessment.",
    "vtext": "[glacial, precise] Vessia... of the lower halls. [short pause] You left the academy with a QUESTION. The faculty has sent me... with the answer. [cold courtesy] Hold still for your assessment." },
  { "id": "e_pr_death", "slot": "Proctor", "who": "THE ASHENVEIL PROCTOR",
    "text": "Marked... incomplete... the Ashenveil... will re-examine...",
    "vtext": "[failing, clipped] Marked... incomplete... [breath] the Ashenveil... will re-examine..." },

  # ---- 2026-08-11 inn rework (Hiro: "make it an innkeeper greeting, concise") ----
  { "id": "m_greet", "slot": "Marlow", "who": "MARLOW",
    "text": "Evening, girl. Bath's hot, stew's thick, beds are clean. Stay the night - the alleys will keep till morning.",
    "vtext": "[warm, easy] Evening, girl. Bath's hot, stew's thick, beds are clean. [smiling] Stay the night... the alleys will keep till morning." },
  { "id": "b_host", "slot": "BrassHost", "who": "THE HOST",
    "text": "Welcome, welcome! Rune-warmed rooms, self-stirring stew, and beds that hum you to sleep. Stay the night, traveler - Brassveil is kinder by lamplight.",
    "vtext": "[bright sing-song] Welcome, welcome! Rune-warmed rooms, self-stirring stew... and beds that HUM you to sleep. [warm upsell] Stay the night, traveler. Brassveil is kinder by lamplight." },

  # ---- 2026-08-11 narrative pass: every enemy speaks ----
  { "id": "e_hd_intro", "slot": "Houndmaster", "who": "THE HOUND MASTER (the stands)",
    "text": "Loose the hound! Gifted blood, boy - the yard eats WELL tonight!",
    "vtext": "[bellowing from above] LOOSE the hound! [snarling relish] Gifted blood, boy... the yard eats WELL tonight!" },
  { "id": "e_bs_intro", "slot": NARR, "who": "NARRATOR",
    "text": "No collar. No handler. No page in any ledger. Some things in the dark were never anyone's to sell.",
    "vtext": "[low warning] No collar. No handler. [pause] No page in any ledger. [quiet dread] Some things in the dark... were never anyone's to sell." },
  { "id": "e_sk_intro", "slot": "PitBones", "who": "PIT SKELETON",
    "text": "Not... done... fighting... the crowd... still... owes me...",
    "vtext": "[hollow rattle] Not... done... fighting... [dry wind] the crowd... still... OWES me..." },
  { "id": "e_br_intro", "slot": "PitBrute", "who": "PIT BRUTE",
    "text": "Little fighter. Big noise. I make quiet.",
    "vtext": "[slow, enormous] Little fighter. [long pause] Big noise. [flat] I make quiet." },
  { "id": "e_wg_intro", "slot": "FrostWight", "who": "FROST WIGHT",
    "text": "So warm... the cold takes better care of things... stay... you will keep... beautifully...",
    "vtext": "[freezing whisper] So warm... [breath of ice] the cold takes better care of things... stay... [lullaby hiss] you will keep... BEAUTIFULLY..." },
  { "id": "n_keepgarrison", "slot": NARR, "who": "NARRATOR",
    "text": "The Keep knows she is coming. What is left of the Tempest School has sold its last contract cheap: one night, one gate, one chance to stand between the Matron's blade and the Emperor's house.",
    "vtext": "[grim, drums underneath] The Keep knows she is coming. [short pause] What is left of the Tempest School has sold its last contract CHEAP. One night. One gate. [rising] One chance to stand between the Matron's blade... and the Emperor's house." },

  # ---- 2026-08-11 level redesign: the Bamboo Road (act 1) ----
  { "id": "n_bamboo", "slot": NARR, "who": "NARRATOR",
    "text": "THE BAMBOO ROAD. Every blade that ever mattered to Karridge came down this road, under these same green shadows. The grove remembers all of them - and says nothing.",
    "vtext": "[hushed, reverent] THE BAMBOO ROAD. [pause] Every blade that ever mattered to Karridge came down this road... under these same green shadows. [quiet] The grove remembers all of them... [dry] and says nothing." },
  { "id": "k_boss1", "slot": "Tsubaki", "who": "TSUBAKI",
    "text": "Three days you have shadowed me through the bamboo, bowman. I know who pays you - grieving families, hunting the cult that took their children. Commendable. But the road to Karridge is mine, and you have seen my face.",
    "vtext": "[courteous, unhurried] Three days you have shadowed me through the bamboo, bowman. [short pause] I know who pays you. Grieving families... hunting the cult that took their children. [soft] Commendable. [steel] But the road to Karridge is mine. And you have seen my face." },
  { "id": "e_sr_yield", "slot": "Sera", "who": "SERA",
    "text": "Enough... enough. Yield. Take your look at his empty study and go. And tell your Lady this, from his FIRST friend: whatever she is preparing for... he will be exactly where she least wants him. He always is.",
    "vtext": "[winded, grudging] Enough... enough. Yield. [breath] Take your look at his empty study... and go. [harder] And tell your Lady this, from his FIRST friend. Whatever she is preparing for... [quiet certainty] he will be exactly where she least wants him. [almost a laugh] He always is." },
]
