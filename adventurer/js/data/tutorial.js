...
ADV.DATA.PROMPTS = {
  ...
  firstLeaderFall:     'If the party leader dies or flees a fight, the contract fails and everyone loses reputation — and a death also disbands the company, so you must join or found another, because a leader does not get back up between battles the way the others do.',
  firstIntentIcon:     'Their portraits show what they plan to do before you act.',
  firstSkillAuto:      'Auto keeps using that skill each turn on the weakest enemy — or, for a heal, the ally (including you) with the least health left — until you turn it off.',
