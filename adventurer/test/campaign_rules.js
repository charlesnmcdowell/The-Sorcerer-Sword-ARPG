...
(function () {
  ...
  ok(ADV.Game.shouldMeetRival(g2, partyJob), 'after two contracts a rival company can appear on a party job');
  ...
  ok(ADV.Game.shouldMeetRival(g2, partyJob), 'two quests later a rival can appear again');
