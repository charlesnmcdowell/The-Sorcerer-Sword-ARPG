...
(async()=>{
 ...
 const backup=path.resolve('archive/dialogue/2026-09-15-gate-finale');
 ...
 globalState.externalPatchRuns??=[];const id='20260915-gate-finale';
 ...
 for(const file of ['data/gate_finale','data/voice_manifest','core/campaign3','core/gate_finale','core/game','ui/gate_art','ui/gate_ambience','ui/gate_cinema','ui/gate_finale']){
