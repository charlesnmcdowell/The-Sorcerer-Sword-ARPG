...
(function () {
  ...
  for (const m of ADV.Courtship.richestMen(world)) if (!m.isPlayer) m.partnerId = 'taken';   // keep the rich off the market for this check
  ...
  const her = world.characters.find(c => c.alive && c.sex === 'f' && !c.isPlayer && !c.partnerId && c !== asker);
